...
namespace SwipeGesture
{
    public class SwipeCommandPageCS : ContentPage
    {
        ...
        {
            var boxView = new BoxView { Color = Colors.Teal, WidthRequest = 300, HeightRequest = 300, HorizontalOptions = LayoutOptions.Center, VerticalOptions = LayoutOptions.Center };
            var label = new Label();
            ...
            Content = new Grid
            {
                ...
                Children = {
                        new Label { Margin = new Thickness(0,10), Text = "Swipe inside the box with a single finger.", HorizontalOptions = LayoutOptions.Center },
                        boxView,
                        label
                    }
            };
