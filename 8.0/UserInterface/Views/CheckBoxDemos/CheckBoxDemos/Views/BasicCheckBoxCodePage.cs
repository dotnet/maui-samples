namespace CheckBoxDemos
{
    public class BasicCheckBoxCodePage : ContentPage
    {
        public BasicCheckBoxCodePage()
        {
            ...
            CheckBox boldCheckBox = new CheckBox { Color = Colors.Red, VerticalOptions = LayoutOptions.Center };
            ...
            CheckBox underlineCheckBox = new CheckBox { Color = Colors.Green, VerticalOptions = LayoutOptions.Center };
            ...
            CheckBox strikethroughCheckBox = new CheckBox { Color = Colors.Blue, VerticalOptions = LayoutOptions.Center };
            ...
            grid.Add(italicLabel, 0, 0);
            grid.Add(italicCheckBox, 1, 0);
            grid.Add(boldLabel, 2, 0);
            grid.Add(boldCheckBox, 3, 0);
            grid.Add(underlineLabel, 0, 1);
            grid.Add(underlineCheckBox, 1, 1);
            grid.Add(strikethroughLabel, 2, 1);
            grid.Add(strikethroughCheckBox, 3, 1);
