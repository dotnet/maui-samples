...
namespace ChatMobile.Client.Tools;
...
public class FileOperationsTool : AIFunction
{
    ...
    public override JsonElement JsonSchema => JsonSerializer.SerializeToElement(new
    {
        ...
        properties = new
        {
            path = new { type = "string", description = "Path or a known folder name: documents, desktop, downloads, pictures, music, videos, home", objectType = "string" },
            max_files = new { type = "integer", description = "Maximum number of items to return (1-100)", @default = 20, minimum = 1, maximum = 100 }
        },
